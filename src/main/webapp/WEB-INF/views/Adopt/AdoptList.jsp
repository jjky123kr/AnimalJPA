				...
				<div class="col">	${survey.adoptionStatus.getKorName()}	
					<div class="card" style="padding-left: 25.5px; margin-top: 100px;">
						...
						<div class="card-img-top">
							...
							<div class="card-body">
								<h5 class="card-title">
									<a href="/adopt/${adopt.id}">${adopt.title}</a>							      							
								</h5>
...
<!-- 검색 했을 경우 :keyword="${keyword}"추가한다.-->
		...
		<ul class="pagination justify-content-center">
			<li class="page-item"><a class="page-link" href="?page=${adopt.number-1}">Previous</a></li>
